...
describe '#valid?' do 
  ...
  it 'placa é unico' do 
    first_vehicle = Vehicle.create!(license_plate:'MRO4H51', brand:'Fiat', model: 'Fiorino', year_of_manufacture: 2019, maximum_load_capacity: 650)
    second_vehicle = Vehicle.new(license_plate:'MRO4H51', brand:'Renault', model: 'Kangoo', year_of_manufacture: 2020, maximum_load_capacity: 800)
